...
public class AdjacencyMatrixGraph implements Graph {
    ...
    public boolean containsEdge(Object a, Object b) throws GraphException, ListException {
        ...
        return !util.Utility.equals(adjacencyMatrix[indexOf(a)][indexOf(b)], 0) 
                && !util.Utility.equals(adjacencyMatrix[indexOf(b)][indexOf(a)], 0);
    }
    ...
    public String dfs() throws GraphException, StackException, ListException {
        setVisited(false); //marca todos los vertices como no
//        vistados // inicia en el vertice 0
...
//el que esta en el tope de la pila
    ...
    public String bfs() throws GraphException, QueueException, ListException {
        setVisited(false); //marca todos los vertices como no
//        visitados // inicia en el vertice 0
        String info = vertexList[0].data + ", ";
        vertexList[0].setVisited(true); // lo marca
        queue.clear();
        ...
        int v2;
        while (!queue.isEmpty()) {
            int v1 = (int) queue.deQueue(); // remueve el vertice de la cola // hasta que no tenga vecinos sin visitar
...
//            if (!util.Utility.equals(adjacencyMatrix[i][j], 0)
//                    && !vertexList[i].isVisited()) {
            if (!adjacencyMatrix[i][j].equals(0)
                    && !vertexList[j].isVisited()) {
                return j;//Retorna la posición del vétice adyacente no visitado
