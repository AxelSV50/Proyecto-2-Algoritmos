...
public class AdjacencyListGraph implements Graph {
    ...
    public boolean containsEdge(Object a, Object b) throws GraphException, ListException {
        ...
        return !vertexList[indexOf(a)].edgesList.isEmpty() && !vertexList[indexOf(b)].edgesList.isEmpty()
                ? vertexList[indexOf(b)].edgesList.contains(new EdgeWeight(a, null)) || vertexList[indexOf(a)].edgesList.contains(new EdgeWeight(b, null))
                : false;
    }
